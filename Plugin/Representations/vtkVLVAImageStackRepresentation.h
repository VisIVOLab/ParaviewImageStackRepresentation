...
=========================================================================*/
// .NAME vtkVLVAImageStackRepresentation
// .SECTION Description
//

#ifndef vtkVLVAImageStackRepresentation_h
#define vtkVLVAImageStackRepresentation_h
...
class VTKREMOTINGVIEWS_EXPORT vtkVLVAImageStackRepresentation : public vtkPVDataRepresentation
{
public:
    static vtkVLVAImageStackRepresentation* New();
    vtkTypeMacro(vtkVLVAImageStackRepresentation, vtkPVDataRepresentation)
     ...
     */
    void SetSliceMode(int);
    vtkGetMacro(SliceMode, int)
    ///@};

    //Adding and removing images from the imagestack
    void AddLayerImage(const std::string file);
    void RemoveLayerImage(const int index);
    ...
    //---------------------------------------------------------------------------
    // Forwarded to Actor and ImageStack.
    ...
    //---------------------------------------------------------------------------
    // Forwarded to vtkVLVAImageStackMapper.
...
protected:
    vtkVLVAImageStackRepresentation();
    ~vtkVLVAImageStackRepresentation();
    ...
    int SliceMode;
    unsigned int Slice;
    unsigned int StackImageSlice;

    vtkVLVAImageStackMapper* SliceMapper;
    vtkPVLODActor* Actor;
...
private:
    vtkVLVAImageStackRepresentation(const vtkVLVAImageStackRepresentation&) = delete;
    void operator=(const vtkVLVAImageStackRepresentation&) = delete;
};
