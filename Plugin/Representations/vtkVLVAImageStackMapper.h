...
=========================================================================*/
// .NAME vtkVLVAImageStackMapper - dummy clone of ImageSlice mapper.
// .SECTION Description
// This is a clone of the standard ImageSlice mapper, to be fiddled with until
// I can get an ImageStack mapper working.

#ifndef vtkVLVAImageStackMapper_h
#define vtkVLVAImageStackMapper_h
...
class VTKREMOTINGVIEWS_EXPORT vtkVLVAImageStackMapper : public vtkMapper
{
public:
    static vtkVLVAImageStackMapper* New();
    vtkTypeMacro(vtkVLVAImageStackMapper, vtkMapper)
...
private:
    vtkVLVAImageStackMapper(const vtkVLVAImageStackMapper&) = delete;
    void operator=(const vtkVLVAImageStackMapper&) = delete;
};
