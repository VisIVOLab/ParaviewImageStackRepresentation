...
=========================================================================*/
#include "vtkVLVAImageStackMapper.h"
...
//-----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::SetPainter(vtkPainter*) {}

vtkStandardNewMacro(vtkVLVAImageStackMapper);
//----------------------------------------------------------------------------
vtkVLVAImageStackMapper::vtkVLVAImageStackMapper()
{
    this->Piece = 0;
...
int vtkVLVAImageStackMapper::SetupScalars(vtkImageData* input)
{
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::RenderInternal(vtkRenderer* renderer, vtkActor* actor)
{
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::ReleaseGraphicsResources(vtkWindow* win)
{
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::Render(vtkRenderer* ren, vtkActor* act)
{
    if (this->Static)
    {
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::SetInputData(vtkImageData* input)
{
    this->SetInputDataInternal(0, input);
}

//----------------------------------------------------------------------------
vtkImageData* vtkVLVAImageStackMapper::GetInput()
{
    return vtkImageData::SafeDownCast(this->GetExecutive()->GetInputData(0, 0));
}

//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::Update(int port)
{
    if (!this->Static)
    {
...
//----------------------------------------------------------------------------
double* vtkVLVAImageStackMapper::GetBounds()
{
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::ShallowCopy(vtkAbstractMapper* mapper)
{
    vtkVLVAImageStackMapper* idmapper = vtkVLVAImageStackMapper::SafeDownCast(mapper);
    if (idmapper)
    {
...
//----------------------------------------------------------------------------
int vtkVLVAImageStackMapper::FillInputPortInformation(int vtkNotUsed(port), vtkInformation* info)
{
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::RenderPiece(vtkRenderer* ren, vtkActor* actor)
{
    vtkImageData* input = this->GetInput();
    //
...
//----------------------------------------------------------------------------
void vtkVLVAImageStackMapper::PrintSelf(ostream& os, vtkIndent indent)
{
